...
class SecondEnergyUsageWidget extends StatefulWidget {
  const SecondEnergyUsageWidget({super.key});
  @override
  State<SecondEnergyUsageWidget> createState() => _SecondEnergyUsageWidgetState();
}

class _SecondEnergyUsageWidgetState extends State<SecondEnergyUsageWidget> {
